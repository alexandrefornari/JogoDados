...
//Fun��o para atualizar a atividade em 60FPS
function tick(event) {
...
function evaluate(event){
    ...
    //Caso um dos campos esteja em branco, envia uma mensagem ao usu�rio.
    if (input == "" || resultado == "") {
        alert("Voc� precisa preencher os dados antes de avaliar.");
        return;
    }
    ...
    if (input.length == 0) {
        ...
        feedback += "A equa��o digitada est� correta!";
    }else{
        //console.log("Sobrou: " + input + " na equacao.");
        feedback += "Preste aten��o nos valores sorteados e tente novamente.";
    }
    ...
    if (soma.toString() == resultado) {
        ...
        feedback += "\nA soma est� incorreta. A soma correta seria " + soma;
    }
...
//Descarrega a tela e os bot�es que est�o carregados
...
//Classe dos dados que ser�o animados
